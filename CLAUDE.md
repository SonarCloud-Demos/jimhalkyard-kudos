...
```bash
sonar analyze agentic --project SonarCloud-Demos_jimhalkyard-kudos --depth DEEP --file <path/to/file1> --file <path/to/file2>
```
...
```bash
sonar analyze agentic --project SonarCloud-Demos_jimhalkyard-kudos --depth DEEP
```
